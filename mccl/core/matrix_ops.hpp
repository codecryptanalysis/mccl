...
void v_set(const v_ptr& v);
void v_clear(const v_ptr& v);
void v_set(const v_ptr& v, bool b);
void v_not(const v_ptr& v);
...
void v_copy   (const v_ptr& dst, const cv_ptr& src);
void v_copynot(const v_ptr& dst, const cv_ptr& src);
void v_and    (const v_ptr& dst, const cv_ptr& v2);
void v_or     (const v_ptr& dst, const cv_ptr& v2);
void v_xor    (const v_ptr& dst, const cv_ptr& v2);
...
void v_and(const v_ptr& dst, const cv_ptr& v1, const cv_ptr& v2);
void v_or (const v_ptr& dst, const cv_ptr& v1, const cv_ptr& v2);
void v_xor(const v_ptr& dst, const cv_ptr& v1, const cv_ptr& v2);
